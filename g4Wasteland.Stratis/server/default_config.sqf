...
// General settings
A3W_startHour = 21;                // In-game hour at mission start (0 to 23)
...
A3W_antiHackMinRecoil = 0.25;       // Mininum recoil coefficient enforced by the antihack (recommended values: default = 1.0, TMR Mod = 0.5, VTS Weapon Resting = 0.25)
...
A3W_payrollAmount = 4000;           // Amount of money rewarded per territory on each payroll
