...
[
	...
	["MX Rifle (Black)", "arifle_MX_Black_F", 525],
	["MX 3GL Rifle", "arifle_MX_GL_F", 550],
	["MX 3GL Rifle (Black)", "arifle_MX_GL_Black_F", 575],

	// Markman Rifles
	["MXM Rifle", "arifle_MXM_F", 600],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 625],
...
[
	["RPG-42 Alamut", "launch_RPG32_F", 1200],
	["PCML", "launch_NLAW_F", 4200],
	["Titan MPRL Compact (Tan)", "launch_Titan_short_F", 7800],
	["Titan MPRL Compact (Brown)", "launch_O_Titan_short_F", 7800],
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", 7800],
...
[
	...
	["Static Titan AT 4Rnd (NATO)", "B_static_AT_F", 5500], // Static launchers only have 4 ammo, hence the low price
	["Static Titan AT 4Rnd (CSAT)", "O_static_AT_F", 5500],
	["Static Titan AT 4Rnd (AAF)", "I_static_AT_F", 5500],
...
[
	...
	["Titan Anti-Air Missile", "Titan_AA", 3350],              // Direct damage: low       | Splash damage: medium | Guidance: aircraft
...
[
	...
	["UAV Terminal (NATO)", "B_UavTerminal", 5500, "gps"],
	["UAV Terminal (CSAT)", "O_UavTerminal", 5500, "gps"],
	["UAV Terminal (AAF)", "I_UavTerminal", 5500, "gps"],
...
[
	...
	["HEMTT Ammo", "B_Truck_01_ammo_F", 100500, "vehicle"],

	["Tempest Device", "O_Truck_03_device_F", 4000, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 36000, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 7500, "vehicle"],
	["Tempest Fuel", "O_Truck_03_fuel_F", 39000, "vehicle"],
	["Tempest Medical", "O_Truck_03_medical_F", 38000, "vehicle"],
	...
	["Zamak Covered", "I_Truck_02_covered_F", 55000, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 57500, "vehicle"],
	["Zamak Medical", "I_Truck_02_medical_F", 59000, "vehicle"],
	["Zamak Repair", "I_Truck_02_box_F", 120000, "vehicle"],
	["Zamak Ammo", "I_Truck_02_ammo_F", 75000, "vehicle"],
...
[
	...
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 860000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 86000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 86000, "vehicle"],
	["MQ4A Greyhawk ATGM UAV", "B_UAV_02_F", 175000, "vehicle"],
...
[
	...
	["CCTV Camera", "cctv_camera", localize "STR_WL_ShopDescriptions_CCTV_Camera", "addons\cctv\icons\camcorder.paa", 850, 500],
	["CCTV Base Station", "cctv_base", localize "STR_WL_ShopDescriptions_CCTV_Base", "addons\cctv\icons\laptop.paa", 8500, 300],
