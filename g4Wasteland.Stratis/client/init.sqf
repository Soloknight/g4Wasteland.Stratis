...
[] execVM "addons\water_edge\functions.sqf"; //Cael817, SNAFU, From micovery
[] execVM "addons\camera\functions.sqf";			// Improved admin camera
[] execVM "addons\cctv\functions.sqf";				// CCTV Camera
[] execVM "addons\UAV_Control\functions.sqf";		// UAVControl
[] execVM "addons\boomerang\functions.sqf";         //boomerand addon micovery
