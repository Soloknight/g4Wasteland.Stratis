...
MF_ITEMS_CAMO_NET1 = "camonet_big";
MF_ITEMS_CAMO_NET_TYPE1 = "CamoNet_BLUFOR_big_Curator_F";
...
mf_items_camo_net_can_pack1 = [_path, "can_pack.sqf"] call mf_compile;
mf_items_camo_net_nearest1 = {
	_camonet = objNull;
...
[MF_ITEMS_CAMO_NET1, "Camo Net Big", _unpack, _ground_type, _icon, 1] call mf_inventory_create;

private ["_label", "_condition", "_action"];
_label = format["<img image='%1' /> Pack up Camouflage Netting", _icon];
_condition = "'' == [] call mf_items_camo_net_can_pack1;";
