...
{
	[format ["deleteExpiredServerObjects:%1:%2:%3:%4", call A3W_extDB_ServerID, call A3W_extDB_MapID, _maxUnusedtime, _saveUnlockedObjects], 2, true] call extDB_Database_async;
};
