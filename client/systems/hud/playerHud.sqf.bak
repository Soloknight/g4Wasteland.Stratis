...
while {true} do
{
	...
	//_serverString = format ["<t color='#A0FFFFFF'>Server: |g4|-Wasteland Stratis 1</t>", call A3W_extDB_ServerID];
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>|g4|A3Wasteland %1<br/>www.g4-gamers.com</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.28;
